...
# Output
my_output <- paste("/Users/test/Desktop/UB/Advanced_Bioinformatics/exercise_02/busco/SRR6130428/","busco_figure.png",sep="/") 
my_width <- 20
my_height <- 15
my_unit <- "cm"
...
my_species <- c('SRR6130428_k63_contigs', 'SRR6130428_k63_contigs', 'SRR6130428_k63_contigs', 'SRR6130428_k63_contigs')
...
my_percentage <- c(96.7, 2.1, 0.5, 0.7)
my_values <- c(2067, 44, 11, 15)
